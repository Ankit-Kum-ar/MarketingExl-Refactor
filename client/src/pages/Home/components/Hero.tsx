...
const Hero = () => {
  ...
  return (
    ...
    <div  ref={heroRef} className='HeroContent  bg-black flex flex-col justify-between  relative h-[90vh] w-screen items-center bg-gradient-to-t from-black via-transparent to-transparent'>
      ...
      <div className='bg-black absolute bottom-0 right-0 z-10 w-48 h-40 md:w-48 md:h-40'></div>
    </div>
